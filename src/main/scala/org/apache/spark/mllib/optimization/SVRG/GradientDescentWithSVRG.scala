...
///*
// By wjf
// wangjianfei15@otcaix.iscas.ac.cn
// */
//
...
//      val  gradientRDD = data.sample(false, miniBatchSize, 42 + i)
//        .mapPartitions{
//            partition => {
...
//              var loss = 0.0
//              for(x <- array) {
//                loss  += gradient.compute(x._2, x._1, bcWeights.value, Vectors.fromBreeze(currentGradient))
//              }
//              currentGradient /= array.length.toDouble
//              val currentW = bcWeights.value
//              for(i<- array.indices) {
//                val index = Math.random() * array.length
//                val tempGradient = gradient
//
//              }
//              Iterator(loss)
//            }
